...
var RevealMenu = window.RevealMenu || (function(){
	...
	function loadPlugin() {
		...
		if (initialise) {
			...
			function closePanelAndFullscreen(event, force) {
			...
			function switchThemeMode() {
			    if(isLightMode){
                    document.getElementById('theme').href = "css/theme/template/mode-dark.css";
                }else{
                    document.getElementById('theme').href = "css/theme/template/mode-light.css";
                }
